...
namespace SwissAcademic.Addons.ScrollSpeedInPdfPreview
{
    partial class Addon
    {
        ...
        public override void OnHostingFormLoaded(MainForm mainForm)
        {
            ...
            var button = toolsMenu.InsertCommandbarButton(toolsMenu.Tool.Tools.IndexOf(toolsMenu.Tool.Tools["SkipPreviewEntryPage"]) - 1, COMMAND_KEY, SwissAcademic.Addons.ScrollSpeedInPdfPreview.Properties.Resources.Command_Text);
        ...
        public override void OnLocalizing(MainForm mainForm)
        {
            ...
            if (button != null)
            {
                button.Text = SwissAcademic.Addons.ScrollSpeedInPdfPreview.Properties.Resources.Command_Text;
            }
        }
    }
}
