...
namespace SwissAcademic.Addons.ReferenceGridFormWorkSpaceEditorAddon
{
    public partial class WorkSpaceEditorForm : FormBase
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            btn_add.Image = Control2.ScaleBitmap(SwissAcademic.Addons.ReferenceGridFormWorkSpaceEditorAddon.Properties.Resources.add);
            btn_down.Image = Control2.ScaleBitmap(SwissAcademic.Addons.ReferenceGridFormWorkSpaceEditorAddon.Properties.Resources.down);
            btn_edit.Image = Control2.ScaleBitmap(SwissAcademic.Addons.ReferenceGridFormWorkSpaceEditorAddon.Properties.Resources.edit);
            btn_remove.Image = Control2.ScaleBitmap(SwissAcademic.Addons.ReferenceGridFormWorkSpaceEditorAddon.Properties.Resources.remove);
            btn_up.Image = Control2.ScaleBitmap(SwissAcademic.Addons.ReferenceGridFormWorkSpaceEditorAddon.Properties.Resources.up);
        }
        ...
        public override void Localize()
        {
            ...
            Text = SwissAcademic.Addons.ReferenceGridFormWorkSpaceEditorAddon.Properties.Resources.WorkSpaceEditor_Form_Text;
        }
        ...
        void Btn_remove_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show(SwissAcademic.Addons.ReferenceGridFormWorkSpaceEditorAddon.Properties.Resources.WorkSpaceEditor_Messages_RemoveWorkSpace.FormatString(workSpace.Caption), "", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
